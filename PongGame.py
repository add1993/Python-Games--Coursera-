...
def draw(canvas):
   ...
   # canvas.draw_circle()
    ...
    # draw paddles
    canvas.draw_polygon([[0, paddle1_pos+HALF_PAD_HEIGHT], [PAD_WIDTH,paddle1_pos+HALF_PAD_HEIGHT ], [PAD_WIDTH, paddle1_pos-HALF_PAD_HEIGHT],[0,paddle1_pos-HALF_PAD_HEIGHT]], 1, "Green", "Red");
    canvas.draw_polygon([[WIDTH-1, paddle2_pos+HALF_PAD_HEIGHT], [WIDTH-1-PAD_WIDTH,paddle2_pos+HALF_PAD_HEIGHT ], [WIDTH-1-PAD_WIDTH, paddle2_pos-HALF_PAD_HEIGHT],[WIDTH-1,paddle2_pos-HALF_PAD_HEIGHT]], 1, "Green", "Blue");
       
    # draw scores
    canvas.draw_text(str(score1),[WIDTH/4,100],50,"White")
    canvas.draw_text(str(score2),[WIDTH-WIDTH/4,100],50,"White")
